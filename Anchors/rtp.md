...
|---|---|
| `/rtp` | Runs the default random teleport. |
| `/rtp cave` | Runs the cave RTP flow. |
| `/rtp world <world-selector>` | Runs RTP against a configured world or route selector. |
| `/rtp <world-selector>` | Shortcut form of the world RTP command. |
| `/rtp biome <biome>` | Runs biome-targeted RTP. |
| `/rtp help` | Shows RTP usage. |
